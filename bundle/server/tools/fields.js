...
import { ListOrganizationFieldsSchema, ListDealFieldsSchema, ListPersonFieldsSchema, GetFieldSchema, } from "../schemas/fields.js";
 ...
 */
export async function listOrganizationFields(params) {
    const client = getClient();
    const queryParams = buildPaginationParamsV1(params.start, params.limit);
    const response = await client.get("/organizationFields", queryParams, "v1");
 ...
 * List deal fields
 */
export async function listDealFields(params) {
    const client = getClient();
    const queryParams = buildPaginationParamsV1(params.start, params.limit);
    const response = await client.get("/dealFields", queryParams, "v1");
    if (!response.success || !response.data) {
        return {
            content: [{
                    type: "text",
 ...
 * List person fields
 */
export async function listPersonFields(params) {
    const client = getClient();
    const queryParams = buildPaginationParamsV1(params.start, params.limit);
    const response = await client.get("/personFields", queryParams, "v1");
    if (!response.success || !response.data) {
        return {
            content: [{
                    type: "text",
...
export async function getField(params) {
    ...
    const response = await client.get(endpoint, undefined, "v1");
    if (!response.success || !response.data) {
        return {
            content: [{
                    type: "text",
